...
struct AppColors {
    ...
    static let orangeMain = Color(red: 0.8, green: 0.4, blue: 0.1) // #CC661A
    ...
    static let brownDeep = Color(red: 0.4, green: 0.2, blue: 0.1) // #663319
    ...
    static let backgroundLight = Color(red: 0.996, green: 0.953, blue: 0.780) // #FEEFA7
